...
<form action="includes/login.inc.php" method="post" > <br>
        ...
        <section class="login-form">
            <h2 style="text-align: center;color:black;background-color:dodgerblue;">Log In</h2>
            <p style="text-align: center;">Please enter your account information</p>
            <hr>
            ...
            <p>no account yet ? <a href="signup.php" style="color:blue"><u>Sign up!</u></a></p>
            <div class="clearfix ">
